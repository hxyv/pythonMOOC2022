...
# 4.6.1 Everything reversed
# Please write a function named `everything_reversed`, which takes a list of 
# strings as its argument. The function returns a new list with all of the items
# on the original list reversed. Also the order of items should be reversed on 
# the new list.
